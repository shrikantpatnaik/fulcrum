...
ActiveRecord::Schema.define(version: 20140308131906) do
  ...
  add_index "project_admins", ["project_id", "user_id"], name: "index_project_admins_on_project_id_and_user_id", using: :btree
